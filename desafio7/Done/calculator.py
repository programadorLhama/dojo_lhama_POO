...
class Calculator:
    ...
    def calculate(self, arg1: int, arg2: int) -> int:
    ...
    def __calculate_first_factor(self, arg1: int) -> int:
        num_1 = (arg1 * 5)/8
        num_2 = math.sqrt(num_1)
        first_factor = num_2 ** 3
        return first_factor
        
    def __calculate_second_factor(self, arg2: int) -> int:
        num_1 = arg2 ** 2
        num_2 = (num_1 + arg2)
        num_3 = (num_2 * 2) / 5
    ...
    def __calculate_final_value(self, first_factor: int, second_factor: int) -> int:
